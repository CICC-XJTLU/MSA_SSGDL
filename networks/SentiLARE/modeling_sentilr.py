...
from networks.subnet.SSGDLModel import SSGDL
    ...
    def forward(self, hidden_states, visual=None, acoustic=None, visual_ids=None, acoustic_ids=None, attention_mask=None, head_mask=None):
        ...
        for i, layer_module in enumerate(self.layer):
            ...
            if i == ROBERTA_INJECTION_INDEX:
                hidden_states = self.SSGDL(hidden_states, visual=visual, acoustic=acoustic, visual_ids=visual_ids, acoustic_ids=acoustic_ids)
